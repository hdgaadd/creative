 ...
 */
public class App {
    private final static String PATH = Address.nameAndAddress("excel.xlsx", App.class);

    private final static String KEYWORD1 = "外企";

    private final static String KEYWORD2 = "深圳";
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (Row row : sheet) {
            ...
            // 是否包含关键字
            if (builder.toString().contains(KEYWORD1) && builder.toString().contains(KEYWORD2) || index++ == 0) {
